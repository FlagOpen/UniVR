...
# Emu3 Tokenizer Path
TOKENIZER_PATH="../UniVR_SFT/src/tokenizer_emu3_ibq"

# Vision Tokenizer Path (for VQ-IBQ, not needed for training with pre-tokenized data)
VQ_MODEL_PATH="../UniVR_SFT/weights/Emu3.5-VisionTokenizer"
...
# WANDB Configuration
EXPERIMENT_NAME="univr_vrgrpo_rl_full"
